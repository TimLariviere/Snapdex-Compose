...
interface PokemonDao {
    ...
    @Query("SELECT * FROM Pokemons") suspend fun getAll(): List<PokemonWithRelations>
...
class PokemonWithRelations {
    @Embedded lateinit var pokemon: PokemonEntity
    ...
    @Relation(parentColumn = "id", entityColumn = "pokemonId", entity = PokemonTypeEntity::class)
    lateinit var types: List<PokemonTypeEntity>

    @Relation(entity = AbilityEntity::class, parentColumn = "abilityId", entityColumn = "id")
    lateinit var ability: AbilityWithTranslation

    @Relation(entity = CategoryEntity::class, parentColumn = "categoryId", entityColumn = "id")
...
class AbilityWithTranslation {
    @Embedded lateinit var ability: AbilityEntity

    @Relation(parentColumn = "id", entityColumn = "abilityId")
