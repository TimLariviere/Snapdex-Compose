    ...
    companion object {
        ...
        fun fromPokemon(pokemon: Pokemon): PokemonUi {
            ...
            return PokemonUi(
                ...
                largeImage = PokemonResourceProvider.getPokemonLargeImageId(context, pokemon.id),
                mediumImage = PokemonResourceProvider.getPokemonMediumImageId(context, pokemon.id),
